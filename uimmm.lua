...
local redzlib = {
	Themes = {
		Darker = {
			...
			["Color Stroke"] = Color3.fromRGB(45, 45, 55),
		...
		Dark = {
			...
			["Color Stroke"] = Color3.fromRGB(65, 65, 75),
			["Color Theme"] = Color3.fromRGB(75, 150, 255),
			["Color Text"] = Color3.fromRGB(255, 255, 255),
			["Color Dark Text"] = Color3.fromRGB(200, 200, 210)
		},
		Purple = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(25, 20, 30)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(35, 30, 40)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(25, 20, 30))
			}),
			["Color Hub 2"] = Color3.fromRGB(30, 25, 35),
			["Color Stroke"] = Color3.fromRGB(50, 40, 60),
			["Color Theme"] = Color3.fromRGB(180, 100, 255),
			["Color Text"] = Color3.fromRGB(245, 240, 250),
			["Color Dark Text"] = Color3.fromRGB(190, 180, 200)
		}
	},
	Info = {
		Version = "1.1.0"
...
function redzlib:MakeWindow(Configs)
	...
	local MainFrame = InsertTheme(Create("ImageButton", ScreenGui, {
		...
		BackgroundColor3 = Theme["Color Hub 2"],
		Name = "Hub",
		ImageTransparency = 1, -- 隐藏ImageButton的图片功能，改用渐变和毛玻璃效果
	}), "Main")
	
	-- 添加渐变背景
	local Gradient = Make("Gradient", MainFrame, {
		Rotation = 45,
		Color = ColorSequence.new({
			ColorSequenceKeypoint.new(0, Theme["Color Hub 2"]:Lerp(Color3.new(1,1,1), 0.1)),
			ColorSequenceKeypoint.new(1, Theme["Color Hub 2"]:Lerp(Color3.new(0,0,0), 0.2))
		})
	})
	
	-- 添加内发光效果
	local InnerGlow = Create("Frame", MainFrame, {
		Size = UDim2.fromScale(1, 1),
	...
	Create("UICorner", TopLine, {CornerRadius = UDim.new(0, 2)})
	...
	local MainScroll = InsertTheme(Create("ScrollingFrame", Components, {
		...
		BackgroundColor3 = Theme["Color Hub 2"]:Lerp(Color3.new(0,0,0), 0.2),
	...
	Make("Corner", MainScroll, UDim.new(0, 8))
	
	local Containers = Create("Frame", Components, {
		Size = UDim2.new(1, -MainScroll.Size.X.Offset - 10, 1, -TopBar.Size.Y.Offset - 5),
	...
	local function ControlSize()
		...
		Containers.Size = UDim2.new(1, -MainScroll.Size.X.Offset - 10, 1, -TopBar.Size.Y.Offset - 5)
	...
	CloseButton.MouseEnter:Connect(function() CloseButton.ImageColor3 = Color3.fromRGB(255, 80, 80) end)
	CloseButton.MouseLeave:Connect(function() CloseButton.ImageColor3 = Theme["Color Dark Text"] end)
	...
	MinimizeButton.MouseEnter:Connect(function() MinimizeButton.ImageColor3 = Theme["Color Theme"] end)
	MinimizeButton.MouseLeave:Connect(function() MinimizeButton.ImageColor3 = Theme["Color Dark Text"] end)
	...
	function Window:Dialog(Configs)
		...
		})Make("Gradient", Frame, {Rotation = 270})Make("Corner", Frame, UDim.new(0, 10))
		...
		CreateTween({Frame, "BackgroundTransparency", 0.1, 0.15})
		...
		function Dialog:Button(Configs)
			...
			for _,Button in pairs(ButtonsHolder:GetChildren()) do
				if Button:IsA("TextButton") then
					Button.Size = UDim2.new(1 / ButtonCount, -(((ButtonCount - 1) * 20) / ButtonCount), 0, 35)
				end
			end
	...
	function Window:MakeTab(paste, Configs)
		...
		local LabelTitle = InsertTheme(Create("TextLabel", TabSelect, {
			Size = UDim2.new(1, TIcon and -28 or -15, 1),
			Position = UDim2.fromOffset(TIcon and 28 or 15),
			BackgroundTransparency = 1,
			Font = Enum.Font.GothamMedium,
			Text = TName,
			TextColor3 = Theme["Color Text"],
		...
		Make("Corner", Container, UDim.new(0, 8))
		...
		function Tab:AddDropdown(Configs)
			...
			local SelectedFrame = InsertTheme(Create("Frame", Button, {
				...
				AnchorPoint = Vector2.new(1, 0.5),
				BackgroundColor3 = Theme["Color Stroke"]
			}), "Stroke")Make("Corner", SelectedFrame, UDim.new(0, 5))
			...
			local function CalculateSize()
				...
				ScrollSize = (math.clamp(Count, 0, 10) * 28) + 12
				...
				local function UpdateSelected()
					if MultiSelect then
						for _,v in pairs(Options) do
							...
							CreateTween({nodes[2], "Size", Stats and UDim2.fromOffset(4, 14) or UDim2.fromOffset(4, 4), 0.35})
